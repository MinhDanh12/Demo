...
using ApiAppDemo.Repositories;
using ApiAppDemo.Repositories.Interfaces;
using ApiAppDemo.Services;
...
namespace ApiAppDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Required to run SQL Server correctly
            services.AddDbContext<DemoBanHangContext>(item => item.UseSqlServer(
